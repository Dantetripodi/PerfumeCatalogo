        ...
        <div className="relative p-6">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-1/2">
              <h2 className="text-2xl md:text-3xl font-serif font-bold text-[#1A2238] mb-2">{perfume.name}</h2>
              ...
              <div className="mb-6">
                <h3 className="text-lg font-serif font-semibold text-[#1A2238] mb-3">Notas de fragancia</h3>
